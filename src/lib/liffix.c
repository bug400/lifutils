/* liffix.c -- Repair an illegal formatted LIF image file */
...
void liffix_usage(void)
  {
    fprintf(stderr,"Usage : lifutils liffix -m Mediumtype [-p] LIFIMAGEFILE\n");
    fprintf(stderr,"        Fix the medium size information of a LIF image file\n");
    fprintf(stderr,"        -m Medium type (cass | disk | hdrive1/2/4/8/16) \n");
